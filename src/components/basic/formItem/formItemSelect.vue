...
/*        //2. 判断当前字段是否required，以便是否显示*
      // console.log('check requie in')
      // for(let singleFieldName of )
        for(let idx in this.inputCheckInfo.rule[this.fieldName]){
          // console.log('idx',idx)
          // console.log('this.inputCheckInfo.rule[this.fieldName][idx]',this.inputCheckInfo.rule[this.fieldName][idx])
          for(let singleAttrName in this.inputCheckInfo.rule[this.fieldName][idx]){
            // console.log('singleAttrName',singleAttrName)
            if('required'===singleAttrName){
              this.fieldRequired=this.inputCheckInfo.rule[this.fieldName][idx][singleAttrName]
            }
          }
        }*/
    },
